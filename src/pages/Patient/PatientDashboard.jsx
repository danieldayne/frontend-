...
import { Calendar, Clock, User, Phone, MapPin, CreditCard, CheckCircle, RefreshCw, Plus, Coins, Settings, Edit3, Save, X, Eye, EyeOff, Lock, Info, Stethoscope, UserCheck, FileText, CalendarPlus, Receipt as ReceiptIcon, Activity, Star, Zap, CalendarDays, CalendarRange, Trash2, Printer } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                {selectedPayment.status === 'completed' && (
                  <button
                    onClick={() => handleShowReceipt(selectedPayment)}
                    className="btn btn-primary flex items-center space-x-2"
                  >
